...
echo -e "0 3 * * * /sbin/reboot >/dev/null 2>&1" >> mycron
     echo -e "*/30 * * * * sudo service prvws1 restart" >> mycron
    echo -e "*/30 * * * * sudo service prvws2 restart" >> mycron
    echo -e "*/30 * * * * sudo service prvws3 restart" >> mycron
    echo -e "*/30 * * * * sudo service prvws4 restart" >> mycron
    echo -e "*/30 * * * * sudo service prvws5 restart" >> mycron
    echo -e "*/30 * * * * sudo service prvws6 restart" >> mycron
     crontab mycron
