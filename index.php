...
<html class="loading">
  ...
  <body class="vertical-layout" data-color="bg-black">   
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Sk Base Checker</strong></h4>
					...
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/autocvv.php">ᴄᴠᴠ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ᴀᴜᴛᴏ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/autoccn.php">ᴄᴄɴ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ᴀᴜᴛᴏ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usdcvv.php" selected="">ᴄᴠᴠ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ᴜꜱᴅ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/usdccn.php">ᴄᴄɴ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ᴜꜱᴅ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eurcvv.php">ᴄᴠᴠ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ᴇᴜʀ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/eurccn.php">ᴄᴄɴ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ᴇᴜʀ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inrcvv.php">ᴄᴠᴠ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ɪɴʀ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/inrccn.php">ᴄᴄɴ ᴄʜᴀʀɢᴇ [ᴄᴜʀʀᴇɴᴄʏ:ɪɴʀ][ʀᴀᴛᴇ_ʟɪᴍɪᴛ ʙʏᴘᴀꜱꜱᴇᴅ][ɪɴᴛᴇɴᴛꜱ]</option>
					<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/sk.php">ꜱᴋ ʟɪᴠᴇ ᴄʜᴇᴄᴋᴇʀ [ᴍᴀꜱꜱ][ꜱᴋ ᴄʜᴇᴄᴋ ʙᴀʟᴀɴᴄᴇ]</option>
					</select>
					
					<textarea rows="1" class="form-control text-center" style="width: 50%; float: left ;"  id="sec" placeholder="sk_live_xxxxxx"></textarea>
					<textarea rows="1"class="form-control text-center" style="width: 50%; float: right margin-bottom: 5px;" id="cst" placeholder="Custom Charge"></textarea></br>

					<button class="btn btn-play btn-bg-gradient-x-blue-cyan text-white" style="width: 49%; float: left;"><i class="fa fa-play"></i> START</button>
					<button class="btn btn-stop btn-bg-gradient-x-red-pink text-white" style="width: 49%; float: right;" disabled><i class="fa fa-stop"></i> STOP</button>
...
<footer>
  <p>Telegram <a href="https://t.me/nohitcc">@nohitcc</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "Sk Base Checker", 
  text: "Join Our Telegram Channel For More Such Contents!",
  icon: 'warning',
